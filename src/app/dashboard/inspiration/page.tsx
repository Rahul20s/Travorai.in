    ...
    <div className="flex flex-col min-h-screen bg-white w-full">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto w-full px-8 py-10 flex flex-col items-center justify-center text-center mt-20">
          <div className="w-20 h-20 bg-purple-50 rounded-full flex items-center justify-center mb-6 text-purple-500">
            <Sparkles className="w-10 h-10" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Get Inspired</h2>
          <p className="text-gray-500 max-w-sm">
            Curated guides, top destinations, and travel tips tailored for you.
          </p>
        </div>
      </main>
    </div>
